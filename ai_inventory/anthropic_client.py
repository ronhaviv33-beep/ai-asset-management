"""
Anthropic-compatible wrapper that routes requests through the AI Inventory
...
Usage (env-var driven):
    ...
    client = Anthropic(api_key="gk-...", gateway_url="https://your-gateway")
...
Note: requires the ``anthropic`` package (pip install anthropic).
"""
from __future__ import annotations

from ai_inventory.headers import build_headers, debug_print
